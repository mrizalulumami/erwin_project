...
SoftwareSerial SIM800L(13,15);                //Serial SIM800L pin
 
String Write_API_key = "G1GAEDTS9LZ6M00B";  //Thingspeak Write API Key
String apn = "internet";   
float kelembaban;
float suhu; 
void setup(){
...
void loop(){
  ...
  ShowSerialData();
  ReadSensor();
  String str="GET https://api.thingspeak.com/update?api_key="+Write_API_key+"&field1=" + String(5) +"&field2="+String(30);
...
void ReadSensor(){
  kelembaban = dhtSensor.getHumidity();
